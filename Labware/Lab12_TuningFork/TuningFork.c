...
#define debounce_cst 20	// 22 msec
// Reset debounce counter to debounce_cst
void debounce_reset_counter(void) {
...
void SysTick_Handler(void){
	...
	// Dont check inputs before switch debounce time
