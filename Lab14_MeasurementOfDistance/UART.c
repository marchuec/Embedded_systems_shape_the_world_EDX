...
void UART_Init_PORTA(void){
  ...
  UART0_IBRD_R = 8;                    // IBRD = int(16,000,000 / (16 * 115200)) = int(8.68055)
...
// as part of Lab 11 implement this function
  ...
  if(n > 9999) {
	...
	do{
		String[i--] = n%10 + 0x30;	// 0x30 to convert to ASCII
		n /= 10;
	} while(n != 0);
...
// as part of Lab 11 implement this function
  ...
  if(n > 9999){
	...
	do {
		String[i--] = n%10 + 0x30;	// 0x30 to convert to ASCII
		n /= 10;
	} while(n != 0);	// When n == 0, all digits have been registered
	
	// Complete with 0
	while(i >= 0) {
		String[i--] = '0';
	}
	String[0] = String[1];	// Add the '.'
	String[1] = '.';
}
